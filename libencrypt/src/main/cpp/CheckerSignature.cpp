...
#include "CheckerSignature.h"
#include <string>

using namespace std;

bool CheckerSignature::isValid(JNIEnv* env, jobject context) {
...
//获取签名信息
jstring CheckerSignature::getSign(JNIEnv* env, jobject context, BaseClasses classes) {
...
bool CheckerSignature::checkSign(JNIEnv* env, jobject context, BaseClasses classes) {
...
//获取包名
jstring CheckerSignature::getPackageName(JNIEnv* env, jobject context, BaseClasses classes) {
...
//检查包名
bool CheckerSignature::checkPkgName(JNIEnv* env, jobject context, BaseClasses classes) {
    jstring  pkgName = getPackageName(env, context, classes);
