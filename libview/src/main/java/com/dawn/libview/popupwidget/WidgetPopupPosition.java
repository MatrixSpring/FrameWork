...
public class WidgetPopupPosition implements PopupWindow.OnDismissListener {
    ...
    private WidgetPopupPosition(Context context) {
        mContext = context;
    }
     ...
     * @return
     */
    public WidgetPopupPosition showAsDropDown(View anchor, int xOff, int yOff) {
    ...
    public WidgetPopupPosition showAsDropDown(View anchor) {
        if (mPopupWindow != null) {
    ...
    public WidgetPopupPosition showAsDropDown(View anchor, int xOff, int yOff, int gravity) {
        if (mPopupWindow != null) {
     ...
     * @return
     */
    public WidgetPopupPosition showAtLocation(View parent, int gravity, int x, int y) {
        if (mPopupWindow != null) {
    ...
    public static class PopupWindowBuilder {
        private WidgetPopupPosition mCustomPopWindow;

        public PopupWindowBuilder(Context context) {
            mCustomPopWindow = new WidgetPopupPosition(context);
        }
        ...
        public PopupWindowBuilder setView(View view) {
            KeyboardUtils.closeKeyboard((Activity) view.getContext());
        ...
        public WidgetPopupPosition create() {
            //构建PopWindow
